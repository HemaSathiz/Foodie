...
class RecepiesRemoteDataSource @Inject constructor(private val retrofit: Retrofit, private val apiService: RestInterface) {

    suspend fun fetchRecepies(): Result<RecepiesResponse> {

        return getResponse(
            request = { apiService.getRecepies() },
